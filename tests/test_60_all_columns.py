...
def test_read_flat_bufr_one_subset_one_filters() -> None:
    ...
    res = pdbufr.read_bufr(TEST_DATA_1, "all", mode="flat")
    ...
    res = pdbufr.read_bufr(TEST_DATA_1, "data", mode="flat")
    ...
    try:
        res = pdbufr.read_bufr(TEST_DATA_1, "", mode="flat")
    except ValueError:
        pass
    ...
    for r in required_columns:
        res = pdbufr.read_bufr(TEST_DATA_1, "all", mode="flat", required_columns=r)
        print(f"r={r}")
        assert isinstance(res, pd.DataFrame)
        assert "edition" in res
        assert "#1#latitude" in res
    ...
    res = pdbufr.read_bufr(
        TEST_DATA_1, "all", mode="flat", required_columns="totalPrecipitationPast6Hours"
    )
    assert isinstance(res, pd.DataFrame)
    assert "edition" in res
    assert "#1#latitude" in res
    ...
    required_columns = ["latitude", ["latitude"], ["latitude", "edition"]]
    for r in required_columns:
        res = pdbufr.read_bufr(TEST_DATA_1, "data", mode="flat", required_columns=r)
    ...
    required_columns = ["latitude", ["latitude"], ["latitude", "edition"]]
    for r in required_columns:
        res = pdbufr.read_bufr(TEST_DATA_1, "header", mode="flat", required_columns=r)
    ...
    # filters
    res = pdbufr.read_bufr(
        TEST_DATA_1, "all", mode="flat", filters={"rdbtimeTime": "115557"}
    )
    ...
    res = pdbufr.read_bufr(
        TEST_DATA_1, "all", mode="flat", filters={"stationNumber": 894}
    )
    ...
    res = pdbufr.read_bufr(
        TEST_DATA_1, "all", mode="flat", filters={"stationNumber": [894, 103]}
    )
...
def test_read_flat_bufr_uncompressed_subsets() -> None:
    ...
    # required columns
    res = pdbufr.read_bufr(
        TEST_DATA_2, "all", mode="flat", required_columns=["airTemperature"]
    )
    ...
    res = pdbufr.read_bufr(
        TEST_DATA_2, "data", mode="flat", required_columns=["airTemperature"]
    )
    ...
    res = pdbufr.read_bufr(
        TEST_DATA_2, "data", mode="flat", required_columns=["edition", "airTemperature"]
    )
    ...
    res = pdbufr.read_bufr(
        TEST_DATA_2, "data", mode="flat", required_columns=["xyz", "airTemperature"]
    )
    ...
    # header filter
    res = pdbufr.read_bufr(TEST_DATA_2, "all", mode="flat", filters={"observedData": 1})
    ...
    # data filter
    res = pdbufr.read_bufr(
        TEST_DATA_2, "all", mode="flat", filters={"stationNumber": 27}
    )
    ...
    res = pdbufr.read_bufr(
        TEST_DATA_2, "all", mode="flat", filters={"stationNumber": [27, 84]}
    )
...
def test_read_flat_bufr_compressed_subsets() -> None:
    res = pdbufr.read_bufr(TEST_DATA_9, "all", mode="flat")
    ...
    # required columns
    res = pdbufr.read_bufr(TEST_DATA_9, "all", mode="flat", required_columns=["cape"])
    ...
    res = pdbufr.read_bufr(
        TEST_DATA_9, "data", mode="flat", required_columns=["edition", "cape"]
    )
    ...
    res = pdbufr.read_bufr(
        TEST_DATA_9, "data", mode="flat", required_columns=["xyz", "cape"]
    )
    ...
    res = pdbufr.read_bufr(
        TEST_DATA_9, "header", mode="flat", required_columns=["edition", "cape"]
    )
    ...
    # header filter
    res = pdbufr.read_bufr(TEST_DATA_9, "all", mode="flat", filters={"observedData": 1})
    ...
    # data filter
    res = pdbufr.read_bufr(
        TEST_DATA_9, "all", mode="flat", filters={"ensembleMemberNumber": 2}
    )
    ...
    res = pdbufr.read_bufr(
        TEST_DATA_9, "all", mode="flat", filters={"ensembleMemberNumber": [2, 4]}
    )
